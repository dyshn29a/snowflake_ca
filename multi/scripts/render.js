...
var SnowflakeCA = (function(){
    ...
    var Controller = (function () {
		...
		function GenerateCanvases(parentDivId, layers, items_per_layer, fps, maxCells, maxGridRows, padding, centerCellCount, diameter){
			...
			var itemCount = layers * items_per_layer;
            ...
            for(var zIndex = -1*layers; zIndex < 0 ; zIndex++){
                ...
                for(var j = 0; j > -items_per_layer; j--){
					...
					/*context.shadowColor = Data.Config.CanvasShadowColor;
					context.shadowBlur = Data.Config.CanvasShadowBlur;
					context.shadowOffsetX = Data.Config.CanvasShadowOffset;
					context.shadowOffsetY = Data.Config.CanvasShadowOffset;*/
